...
from .public_methods import AlbumMethods, AnnotationMethods, ArticleMethods, ArtistMethods, CoverArtMethods, DiscussionMethods, LeaderboardMethods, MiscMethods, QuestionMethods, ReferentMethods, SearchMethods, SongMethods, UserMethods, VideoMethods
...
class API(Sender):
    ...
    """
    def __init__(self, access_token, response_format=..., timeout=..., sleep_time=..., retries=..., user_agent=..., proxy=...) -> None:
        ...
    ...
    def annotation(self, annotation_id, text_format=...): # -> str | Any | Literal[204]:
    ...
    def create_annotation(self, text, raw_annotatable_url, fragment, before_html=..., after_html=..., canonical_url=..., og_url=..., title=..., text_format=...): # -> str | Any | Literal[204]:
    ...
    def downvote_annotation(self, annotation_id, text_format=...): # -> str | Any | Literal[204]:
    ...
    def unvote_annotation(self, annotation_id, text_format=...): # -> str | Any | Literal[204]:
    ...
    def update_annotation(self, annotation_id, text, raw_annotatable_url, fragment, before_html=..., after_html=..., canonical_url=..., og_url=..., title=..., text_format=...): # -> str | Any | Literal[204]:
    ...
    def upvote_annotation(self, annotation_id, text_format=...): # -> str | Any | Literal[204]:
    ...
    def artist_songs(self, artist_id, per_page=..., page=..., sort=...): # -> str | Any | Literal[204]:
        """Gets artist's songs.
    ...
    def referents(self, song_id=..., web_page_id=..., created_by_id=..., per_page=..., page=..., text_format=...): # -> str | Any | Literal[204]:
    ...
    def search_songs(self, search_term, per_page=..., page=...): # -> str | Any | Literal[204]:
    ...
    def web_page(self, raw_annotatable_url=..., canonical_url=..., og_url=...): # -> str | Any | Literal[204]:
...
class PublicAPI(Sender, AlbumMethods, AnnotationMethods, ArticleMethods, ArtistMethods, CoverArtMethods, DiscussionMethods, LeaderboardMethods, QuestionMethods, ReferentMethods, SearchMethods, SongMethods, UserMethods, VideoMethods, MiscMethods):
    ...
    """
    def __init__(self, response_format=..., timeout=..., sleep_time=..., retries=..., user_agent=..., **kwargs) -> None:
        ...

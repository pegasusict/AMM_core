...
class Genius(API, PublicAPI):
    ...
    """
    default_terms = ...
    def __init__(self, access_token=..., response_format=..., timeout=..., sleep_time=..., verbose=..., remove_section_headers=..., skip_non_songs=..., excluded_terms=..., replace_default_terms=..., retries=..., user_agent=..., proxy=...) -> None:
        ...
    
    def lyrics(self, song_id=..., song_url=..., remove_section_headers=...): # -> str | None:
    ...
    def search_album(self, name=..., artist=..., album_id=..., get_full_info=..., text_format=...): # -> Album | None:
    ...
    def search_song(self, title=..., artist=..., song_id=..., get_full_info=...): # -> Song | None:
    ...
    def search_artist(self, artist_name, max_songs=..., sort=..., per_page=..., get_full_info=..., allow_name_change=..., artist_id=..., include_features=...): # -> Artist | None:
    ...
    def save_artists(self, artists, filename=..., overwrite=..., ensure_ascii=...): # -> None:
